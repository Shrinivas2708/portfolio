...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0 space-y-1">
...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 h-full w-full opacity-10 group-hover/product:opacity-80 bg-black pointer-events-none"></div>
